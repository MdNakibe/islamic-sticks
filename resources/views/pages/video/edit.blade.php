                                    ...
                                    <form action="{{ route('admin.videos.update', $video->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" id="path" class="form-control" name="path" value="{{ $video->path }}" placeholder="Path">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label required">Priority</label>
                                                <input type="number" class="form-control" name="priority" value="{{ $video->priority }}" placeholder="Priority">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label required">
                                                    <input type="checkbox" class="form-checkbox" name="status" @if($video->status == 1) checked @endif>
                                                    Status
                                                </label>
                                            </div>
