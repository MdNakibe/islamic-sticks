        ...
        <div class="container-fluid stickContainer">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('admin.videos.create') }} " class="btn btn-primary d-none d-sm-inline-block">
                            + Create New
                        </a>
                            ...
                            <tr data_id="{{ $item->id }}">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.videos.edit', $item->id) }}" class="btn btn-sm btn-info mx-2">Edit</a>
                                        <form action="{{ route('admin.videos.delete', $item->id) }}" onsubmit="return confirm('Are you sure to delete?')" method="post">
                                            @csrf
                                            @method('DELETE')
