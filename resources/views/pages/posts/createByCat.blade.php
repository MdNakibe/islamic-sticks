...
@section('content')
            ...
            <div class="container-fluid">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <h1 class="">
                            Post Create for &nbsp; <span style="color: red;">{{ $category->name }}</span>
                        </h1>
                    </div>
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            <a href="{{ route('admin.posts.listByCategory', $category->slug) }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.posts.store') }}" method="POST"
                                    ...
                                    <input type="hidden" name="redirect_link" value="{{ route('admin.posts.listByCategory', $category->slug) }}">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label class="form-label required">Title</label>
                                            <input type="text" class="form-control" name="title" id="title"
                                                value="" placeholder="Input placeholder" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
    ...
    @push('js')
        <script src="{{ asset('js/tinymce_6.5.1/tinymce.min.js') }}" referrerpolicy="origin"></script>
        ...
        <script>
            ...
            const Ctinymce = tinymce.init({
                ...
                plugins: 'preview importcss searchreplace autolink save directionality visualblocks visualchars fullscreen image link media template codesample table charmap pagebreak nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons',
                ...
                toolbar: 'boxtemplate inlinebox undo redo | bold italic underline strikethrough | fontfamily fontsize blocks | alignleft aligncenter alignright alignjustify | outdent indent |  numlist bullist checklist | forecolor backcolor casechange permanentpen formatpainter removeformat | pagebreak | charmap emoticons | fullscreen  preview save print | insertfile image media pageembed template link anchor codesample | a11ycheck ltr rtl | showcomments addcomment | footnotes | mergetags',
