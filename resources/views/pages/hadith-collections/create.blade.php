                        ...
                        <div>
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    ar
                                    <!-- Create Post Form -->
                                    <form action="{{ route('admin.hadith_collections.store') }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea name="en" class="form-control" id="english" rows="3">{{ old('english') }}</textarea>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <label class="form-label ">Arabic</label>
                                                <textarea name="ar" class="form-control" id="arabic" rows="3">{{ old('arabic') }}</textarea>
                                            </div>
