                                    ...
                                    <form action="{{ route('admin.advertise.update', $advertise->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" value="{{ $advertise->link }}" class="form-control" name="link"
                                                    placeholder="Advertise link">
                                            </div>
                                            {{-- <div class="col-md-6 mb-3">
                                                <label class="form-label ">Start Date</label>
                                                <input type="date" value="{{ $advertise->start_date }}" class="form-control" name="start_date" >
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label ">End Date</label>
                                                <input id="daterange" type="date" value="{{ $advertise->end_date }}" class="form-control" name="end_date" >
                                            </div> --}}
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label ">Category</label>
                                                <select name="category_id" class="form-select">
                                                    @foreach ($categories as $item)
                                                    <option value="{{ $item->id }}" @if($item->id == $advertise->category_id) selected @endif>{{ $item->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="type" class="form-select">
                                                    <option value="bottom" @if($item->type == 'bottom') selected @endif>Bottom</option>
                                                    <option value="right" @if($item->type == 'right') selected @endif>Right</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label ">Duration in minute</label>
                                                <input type="number" class="form-control" name="duration" value="{{ $advertise->duration }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label class="form-label ">Priority</label>
                                                <input type="number" class="form-control" name="priority" value="{{ $advertise->priority }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div id='img_contain1'>
                                                    <img id="image_preview1"
                                                        src="{{ asset($advertise->image_phone) }}"
                                                        style="width: 300px;margin-top: 10px; margin-bottom: 10px;" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div>
                                                <label class="form-check">
                                                    <input name="status" class="form-check-input" type="checkbox" @if($advertise->status == 1) checked @endif>
