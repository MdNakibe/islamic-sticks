                                    ...
                                    <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" value="" placeholder="Input placeholder">
                                            </div>
                                            {{-- <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="slug" id="slug" value="" placeholder="Input placeholder">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label required">Priority</label>
                                                <input type="number" class="form-control" name="priority" value="" placeholder="Input placeholder">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label required">Column</label>
                                                <input type="number" class="form-control" name="column" value="" placeholder="Column" accept="image/*">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <label class="form-check">
                                                    <input class="form-check-input" name="print_title" type="checkbox" value="">
