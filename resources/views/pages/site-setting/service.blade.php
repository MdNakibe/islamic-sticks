                ...
                <div class="row g-2 align-items-center">
                    <div class="col">
                        ...
                        <div class="page-pretitle">
                            Site Setting 
                            {{-- {{ dd(getSettings($siteSetting, 'about', 'slugan')) }} --}}
                        </div>
                    </div>
                                    ...
                                    <form action="{{ route('admin.site-setting.update', $setting->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" name="settings[slugan]" class="form-control" placeholder="About slugan"  value="{{ @$setting->settings['title'] }}">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">Image</label>
                                                <input type="file" name="image[image1]" class="form-control" placeholder="About image"  value="{{ @$setting->settings['image'] }}">
                                            </div>
