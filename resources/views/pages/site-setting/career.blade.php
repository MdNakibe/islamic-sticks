                                    ...
                                    <form action="{{ route('admin.site-setting.update', $setting->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea type="text" id="career_text" class="form-control" name="settings[career_text]" cols="100" rows="6"
                                                    placeholder="textarea placeholder">{{ @$setting->settings['career_text'] }}</textarea>
                                            </div>
