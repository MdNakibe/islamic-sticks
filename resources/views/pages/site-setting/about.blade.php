                                    ...
                                    <form action="{{ route('admin.site-setting.update', $setting->id) }}" method="POST"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea type="text" id="about_text" class="form-control" name="settings[about_text]" cols="170" rows="10"
                                                    placeholder="textarea placeholder">{{ @$setting->settings['about_text'] }}</textarea> 
                                            </div>
