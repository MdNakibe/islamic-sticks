...
<body class="bg-white dark:bg-slate-700 group/body" x-data="{ open: true, darkOpen: false, searchModal: false }">
    ...
    <div
        ...
        <div class="grid">
            <ul class="grid justify-center text-center py-5 items-center gap-2">
                ...
                <li><a class="p-2 block font-[500]" href="{{ route('donate') }}">Donate</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="pt-10 sm:pt-16 xl:pt-20 pb-7 text-[17px] sm:pb-10 xl:pb-14 bg-[#f4e9b3] text-[#000]">
            <div class="max-w-[1200px] mx-auto grid text-center gap-6 sm:gap-5 px-5 xl:px-0 dark:text-white">
                ...
                <div class="flex flex-wrap gap-10 justify-center">
                    <a href="{{ route('donate') }}" class="hover:text-primary-500 dark:hover:text-slate-800">Donate</a>
    ...
    <script type="text/javascript" src="https://translate.google.com/translate_a/element.js?exclude=en"></script>
    ...
    <script type="text/javascript">
        ...
        if (localStorage.getItem('lng')) {
            $('#language-select').val(localStorage.getItem('lng'))
        }

        $('#language-select').change(function(){
            let val = $(this).val();
            $('.goog-te-combo').val(val);
