        ...
        <div class="flex flex-wrap flex-col md:flex-row gap-5 lg:gap-14 px-5 xl:px-0">
            <div class="flex-1 max-w-screen-xl md:mx-auto pt-14 pb-5 gap-5 sm:gap-10 ">
                <div class="grid gap-10">
                    <div>
                        <h1 class="text-[16px] text-center font-medium dark:text-white">CLICK ON NAMES FOR MORE DETAILS…</h1>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 justify-between gap-5 md:gap-10">
                        <a href="/post-details" class="col-span-1 bg-[#b6d7da] drop-shadow-lg py-10 text-center rounded">
                            {{-- <img src="{{ asset('frontend/images/how-to-pray-salah/20230412_1359461-1024x580.jpg') }}" alt="img"> --}}
                            <p class="font-medium text-[18px]">Ar-Rahman</p>
                        </a>
                        <a href="#" class="col-span-1 bg-[#b6d7da] drop-shadow-lg py-10 text-center rounded">
                            <p class="font-medium text-[18px]">Ar-Rahman</p>
                        </a>
                        <a href="#" class="col-span-1 bg-[#b6d7da] drop-shadow-lg py-10 text-center rounded">
                            <p class="font-medium text-[18px]">Ar-Rahman</p>
