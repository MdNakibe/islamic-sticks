        ...
        <div class="flex flex-wrap flex-col md:flex-row gap-5 lg:gap-14 px-5 xl:px-0">
            <div class="flex-1 max-w-screen-xl md:mx-auto pt-14 pb-5 gap-5 sm:gap-10 ">
                <div class="grid gap-10">
                    <div>
                        <h1 class="text-[16px] text-center font-medium dark:text-white">HOW TO PRAY…</h1>
                        <span class="w-[50px] mx-auto h-[2px] block bg-slate-600 dark:bg-slate-50"></span>
                    </div>
                    <div class="grid grid-cols-2 sm:grid-cols-3 justify-between gap-5 md:gap-10">
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/20230412_1359461-1024x580.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/asar21-1024x574.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/dhuhr11-1024x580.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/duha11-1024x575.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/fajr11-1024x574.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/isha11-1024x577.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/Istikhara_11-1024x576.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/janazah11-1024x580.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/jummah11-1024x576.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/maghrib11-1024x579.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/tahajjud11-1024x580.jpg') }}" alt="img">
                        </a>
                        <a href="#" class="col-span-1 drop-shadow-lg">
                            <img src="{{ asset('frontend/images/how-to-pray-salah/witr11-1024x573.jpg') }}" alt="img">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full md:w-[250px] lg:w-[300px] pb-[50px]">
                <div class="py-5 md:pt-14 md:pb-5 relative ">
                    <h1 class="text-[25px] font-medium dark:text-white bg-third-50 dark:bg-slate-700 pr-5 inline-block z-10">Recent Posts</h1>
                    <span class="w-full h-[1px] bg-slate-500 dark:bg-slate-200 block absolute bottom-[30%] -z-10"></span>
                </div>
