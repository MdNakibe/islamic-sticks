    ...
    <section class="relative z-10 overflow-hidden bg-white dark:bg-slate-700 py-32 lg:py-[50px] px-5 sm:px-0">
        <div class="max-w-[1200px] mx-auto">
            <div class=" flex flex-wrap lg:justify-between">
                <div class="w-full sm:px-4 lg:w-1/2 xl:w-6/12 dark:text-white">
                    <div class="mb-12 max-w-[570px] lg:mb-0">
                        ...
                        <div class="mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class=" dark:bg-slate-700 text-base">153 Boleyn Road, London E7 9QH, United Kingdom</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
                            ...
                            <div class="w-full">
                                ...
                                <p class=" dark:bg-slate-700 text-base">+44 7570 948135</p>
                            </div>
                        </div>
                        <div class="mb-8 flex w-full max-w-[370px]">
                            <div
